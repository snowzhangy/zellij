...
use zellij_utils::{
    data::{ConnectToSession, LayoutInfo, Palette},
    errors::ErrorContext,
...
mod web_client_tests {
    ...
    async fn test_terminal_metrics_translates_to_pixel_dimensions() {
        ...
        // Send the actual TerminalMetrics payload. Hand-construct the JSON
        // to lock in the exact field names the browser uses, rather than
        // going through Serialize and masking rename mismatches.
